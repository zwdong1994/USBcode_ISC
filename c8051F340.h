...
//-----------------------------------------------------------------------------
extern void K9FReset(void);
extern unsigned int K9FReadID(void);
extern unsigned char K9FReadAData(unsigned char comm,unsigned char columndata,unsigned char pageh, unsigned char pagel) ;  
extern unsigned char K9FProgramData(unsigned char *xramadd);
extern void K9FReadPageData();
extern unsigned char K9FEraseBlockData(unsigned int block);


#define MAX_BUFFER_SIZE    5           // Maximum buffer Master will send

#define  WRITE_ENABLE       0x06        // 
#define  WRITE_DISABLE      0x04        // 
#define  SPI_RDSR                0x05        // Read status register
#define  SPI_WRSR               0x01        // Write status register
#define  SPI_RDI                  0x9f        //  Read Identification
#define  SPI_RMDI                0x90        //  Read Manufacturer and Device ID


#define  SPI_RDDA               0x03        // Read data
#define  SPI_PP                    0x02        // Page program
#define  SPI_CE                    0xc7        // c7/60 Chip erase
#define  ASK_DEVICE            0xf1       //
#define  ASK_BUFFER            0xf2       //
#define  SET_IO                     0xf3       //
#define  SPI_SP2                  0x0A        // Write status register
//#define REV_DATA_ERR       0xf3       //
...
typedef union                                         //ÖÐ¶Ï¼Ä´æÆ÷
{
 unsigned int val;
 //unsigned char faddr[2];
 struct 
  {
   unsigned int page  :5;
